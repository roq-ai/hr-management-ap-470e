...
export function useJobPostFindMany<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useJobPostFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.job_post.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useJobPostCount<T extends Prisma.job_postCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.job_postCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useJobPostCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.job_post.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useJobPostFindManyWithCount<
  T extends Prisma.job_postFindManyArgs,
  R extends { data: GetFindResult<Prisma.$job_postPayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.job_postFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useJobPostFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.job_post.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useJobPostFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useJobPostFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.job_post.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
