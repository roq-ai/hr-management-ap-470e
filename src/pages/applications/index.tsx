...
export function ApplicationListPage(props: ApplicationListPageProps) {
      ...
      convertQueryToPrismaUtil(
        {
          ...
          searchTermKeys: ['status.contains', 'cover_letter.contains', 'resume.contains'],
          ...params.filters,
        },
        'application',
      ),
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('job_post', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'job_post',
          header: 'Job Post',
          accessorKey: 'job_post',
          cell: ({ row: { original: record } }: any) => (
            <Link as={NextLink} onClick={(e) => e.stopPropagation()} href={`/job-posts/view/${record.job_post?.id}`}>
              {record.job_post?.title}
            </Link>
          ),
        }
      : null,
