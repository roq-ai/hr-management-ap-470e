...
import { useRoqPlatformUserProfiles, useDepartmentCount, useApplicationCount, useJobPostCount } from 'lib/roq';
...
function DashboardPage() {
  ...
  const jobPostStat = useJobPostCount();
  ...
  const statResults: { title: string; result: number; change: number; isLoading: boolean }[] = [
    ...
    {
      title: 'Job Posts',
      result: jobPostStat?.data,
      isLoading: jobPostStat.isLoading,
      change: Math.floor(Math.random() * (100 - 40 + 1) + 40),
    },
