  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Elevate Your Business Processes with HR Management Application - Streamlining Human Resources for a More Efficient Workforce"
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Elevate Your Business Processes with HR Management Application - Streamlining Human Resources for a More Efficient Workforce`}
            </Text>
            <Box
