...
function JobPostViewPage() {
  ...
  const { data, error, isLoading } = useJobPostFindFirst(queryParams, {}, { disabled: !id });
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('job_post', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/job-posts/edit/${id}`} passHref legacyBehavior>
                    <Button
